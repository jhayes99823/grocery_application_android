package com.example.hayes.mygrocerylist.Data;
...
import com.example.hayes.mygrocerylist.Utils.Constants;
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public Grocery getGrocery(int id) {
        ...
        if (cursor != null) {
            ...
            temp.setId(Integer.parseInt(cursor.getString(cursor.getColumnIndex(Constants.KEY_ID))));
            temp.setName(cursor.getString(cursor.getColumnIndex(Constants.KEY_GROCERY_ITEM)));
            temp.setQuantity(cursor.getString(cursor.getColumnIndex(Constants.KEY_QTY_NUMBER)));
            ...
            temp.setDateItemAdded(formattedDate);
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                String formattedDate = dateFormat.format(new Date(
                        cursor.getLong(cursor.getColumnIndex(Constants.KEY_DATE_NAME))).getTime());
