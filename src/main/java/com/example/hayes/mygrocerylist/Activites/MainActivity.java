...
//        Log.d("Item Aded Id", String.valueOf(db.getGroceriesCount()));
    ...
    public void byPassActivity() {
        // check if database is empty - if not go to ListActivity
        // to show already added items
        if (db.getGroceriesCount() > 0) {
            startActivity(new Intent(MainActivity.this, ListActivity.class));
            finish(); // gets rid of previous activity and won't go back here
        }
    }
